...
export class Render {
    ...
    drawScene2(programInfo: ProgramInfo, scene: Scene, camera: Camera) {
        // Clear screen
    ...
    initBuffers2(gameObject: GameObject): Buffers | null {
        let gl = this.gl;
    ...
    initPositionBuffer2(gameObject: GameObject) {
        let gl = this.gl;
    ...
    initColourBuffer2(gameObject: GameObject) {
        let gl = this.gl;
    ...
    initIndexBuffer2(gameObject: GameObject) {
        let gl = this.gl;
